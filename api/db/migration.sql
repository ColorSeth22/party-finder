-- Migration to bootstrap Campus Party Finder tables
-- Run this sequentially in your SQL console when migrating an existing QuietLocations database

-- Ensure baseline user table exists
